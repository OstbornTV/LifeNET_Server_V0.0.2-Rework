...
_message = "";
_message = _message + "<t align='center' size='8' shadow='0'>LifeNET</t><br /><br />";
_message = _message + "LifeNET, formerly Altis Life RPG and ARMARPGLIFE is a roleplay framework for ArmA III originally made by TAW_Tonic.<br /><br />";
...
_message = _message + "Thanks for joining and enjoy your stay, <a color='#B000FF'>LifeNET RPG</a> Staff Team.<br />";
