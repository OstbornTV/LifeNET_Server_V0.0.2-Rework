...
if !(isClass (missionConfigFile >> "Licenses" >> _type)) exitWith {}; // Ungültiger Eintrag?
...
if (CASH < _price) exitWith {
    hint format [localize "STR_NOTF_NE_1", [_price] call life_fnc_numberText, _displayName];
};
